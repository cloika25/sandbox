import {
  ...
  o,
  p
} from "./chunk-45TFZ7F4.js";
import {
  require_react
} from "./chunk-4FZVBADS.js";
import {
  __commonJS,
  __toESM
...
var require_shim = __commonJS({
  "node_modules/.pnpm/use-sync-external-store@1.4.0_react@19.0.0/node_modules/use-sync-external-store/shim/index.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
...
// node_modules/.pnpm/use-sync-external-store@1.4.0_react@19.0.0/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js
var require_with_selector_development = __commonJS({
  "node_modules/.pnpm/use-sync-external-store@1.4.0_react@19.0.0/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    "use strict";
    (function() {
      function is(x, y2) {
        return x === y2 && (0 !== x || 1 / x === 1 / y2) || x !== x && y2 !== y2;
...
// node_modules/.pnpm/use-sync-external-store@1.4.0_react@19.0.0/node_modules/use-sync-external-store/shim/with-selector.js
var require_with_selector = __commonJS({
  "node_modules/.pnpm/use-sync-external-store@1.4.0_react@19.0.0/node_modules/use-sync-external-store/shim/with-selector.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
...
// node_modules/.pnpm/effector-react@23.3.0_effector@23.2.3_react@19.0.0/node_modules/effector-react/effector-react.mjs
...
function t(e2, t2) {
  ...
  const o3 = Array.isArray(r2), s2 = import_react.default.useRef({ stale: 1, justSubscribed: 0, scope: t2 }), [u2, c2, a2, i2, l2] = import_react.default.useMemo(() => {
    ...
    for (const s3 in r2) {
      if (!{}.hasOwnProperty.call(r2, s3))
        continue;
      const i3 = r2[s3];
      ae.unit(i3) || E(`expect useUnit ${n2 ? "argument" : `value in key "${s3}"`} to be a unit`), ae.event(i3) || ae.effect(i3) ? (e3[s3] = t2 ? F(i3, { scope: t2 }) : i3, c3.push(s3), a3.push(i3)) : (e3[s3] = null, o4.push(s3), u3.push(i3));
    }
    ...
    const n3 = s2.current;
    return n3.justSubscribed = 1, D({ unit: a2, fn: () => {
...
function n([e2, t2], n2) {
  ...
  const a2 = import_react.default.useCallback((e3) => D({ unit: s2, fn: e3, scope: n2 }), [s2, n2]), i2 = import_react.default.useCallback(() => U(s2, n2), [s2, n2]), l2 = import_react.default.useRef(), f2 = import_react.default.useRef(), p3 = import_react.default.useRef(u2);
  return R(a2, i2, i2, (e3) => {
    if (l2.current !== e3 || !((e4, t3) => {
      if (!e4 || !t3 || e4.length !== t3.length)
        return 0;
      let n3 = 1;
...
function u(e2, t2) {
  return ((e3, t3) => {
    ...
    const n2 = import_react.default.useCallback((n3) => D({ unit: e3, fn: n3, scope: t3 }), [e3, t3]), r2 = import_react.default.useCallback(() => U(e3, t3), [e3, t3]);
    return O(n2, r2, r2);
  })(e2, o2(null == t2 ? void 0 : t2.forceScope));
}
function c(e2, n2) {
...
function p2(t2, n2) {
  ...
  let o3;
  B("createComponent", "@effector/reflect"), ae.store(t2) ? o3 = t2 : "object" == typeof t2 && null !== t2 ? o3 = g(t2) : E("shape should be a store or object with stores");
  let s2 = "Unknown";
...
function y(e2, t2) {
  ...
  })(I(r2 = n2) || ((e3) => "function" == typeof e3)(r2));
  let o3 = n2.or;
  const s2 = n2.and;
  if (s2) {
    const n3 = t2 ? s2 : s2[0];
...
function v(...t2) {
  return (({ domain: t3, defaultState: n2, hook: r2, mainConfig: s2, maybeConfig: u2 }) => {
    ...
    const a2 = z({ or: u2, and: s2 }), i2 = `${t3 ? `${t3.compositeName.fullName}/` : ""}${a2.name || "gate"}`, l2 = p({ name: `${i2}.set`, sid: a2.sid ? `${a2.sid}|set` : void 0 }), f2 = p({ name: `${i2}.open`, sid: a2.sid ? `${a2.sid}|open` : void 0 }), p3 = p({ name: `${i2}.close`, sid: a2.sid ? `${a2.sid}|close` : void 0 }), d2 = h(Boolean(0), { name: `${i2}.status`, serialize: "ignore" }).on(f2, () => Boolean(1)).on(p3, () => Boolean(0)), y2 = h(n2, { name: `${i2}.state`, sid: a2.sid }).on(l2, (e2, t4) => t4).on(f2, (e2, t4) => t4).reset(p3);
    if (t3) {
      const { hooks: e2 } = t3;
...
var z = (e2, t2 = {}) => (I(e2) && (z(e2.or, t2), ((e3) => {
  for (const o3 in e3)
    r2 = o3, ((e4) => void 0 === e4)(n2 = e3[o3]) || "or" === r2 || "and" === r2 || (t2[r2] = n2);
  var n2, r2;
})(e2), z(e2.and, t2)), t2);
export {
  L as Provider,
