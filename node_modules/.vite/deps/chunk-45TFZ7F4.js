// node_modules/.pnpm/effector@23.2.3/node_modules/effector/effector.mjs
function e(e2, t2) {
  for (const r2 in e2)
    t2(e2[r2], r2);
}
...
function o(e2, r2, n2) {
  ...
  if (e2.target && (r2 = e2.params, n2 = e2.defer, a2 = e2.meta, o2 = "page" in e2 ? e2.page : o2, e2.stack && (s2 = e2.stack), i2 = U(e2) || i2, e2 = e2.target), i2 && et && i2 !== et && (et = null), Array.isArray(e2))
    for (let t2 = 0; t2 < e2.length; t2++)
      Qe("pure", o2, E(e2[t2]), s2, r2[t2], i2, a2);
  else
    Qe("pure", o2, E(e2), s2, r2, i2, a2);
  if (n2 && !tt)
    return;
...
function b(e2, t2 = {}) {
  ...
  const d2 = i2.finally = p({ named: "finally", derived: 1 }), u2 = i2.done = d2.filterMap({ named: "done", fn({ status: e3, params: t3, result: r2 }) {
    ...
    if (t3.runnerFn && !t3.runnerFn(e3, null, r2))
      return;
...
function j(...t2) {
  ...
  let w2;
  if (g2 || y2)
    g2 && v2.add(c2), w2 = [g2 && Ee(L(c2), 0, 1), De({ safe: g2, filter: 1, pure: !g2, fn(e2, t3, r2) {
    ...
    e(c2, (e2, a2) => {
      ...
      for (let a2 = 0; a2 < k2.length; a2++) {
        const o3 = k2[a2];
        if (oe(r2, o3) ? n4.a[o3] : c2[o3](e2))
          return void _t(t4, o3, e2, n4);
      }
      _t(t4, "__", e2, n4);
    }, 1)];
  } else
...
function R(e2, { values: n2 }) {
  ...
  ne(e2) ? (u2 = e2, p2 = 1, r(u2.cloneOf, "scope should be created from domain"), ce(0, "hydrate(fork(domain), { values })", "fork({ values })"), f2 = E(u2.cloneOf)) : re(e2) ? (ce(0, "hydrate(domain, { values })", "fork({ values })"), f2 = E(e2)) : r(0, "first argument of hydrate should be domain or scope"), N(f2, (e3, t2) => {
    if (t2 && oe(i2, t2)) {
      ...
      e3.scope.state.id in c2 && (ie(l2, e3), ie(d2, s2.get(c2[e3.scope.state.id])));
...
var Je = 0;
for (; Je < 6; )
  ie(Ge, { first: null, last: null, size: 0 }), Je += 1;
var Ke = () => {
...
var pt = (e2, r2, n2, a2, o2) => {
  ...
  if (c2.id in e2.values.idMap)
    c2.current = e2.values.idMap[c2.id];
...
var yt = (e2, t2, r2) => {
  ...
  let a2 = T(e2);
  for (; n2 = a2.pop(); )
    gt(n2, e2), (t2 || r2 && "sample" !== e2.meta.op || "crosslink" === n2.family.type) && yt(n2, t2, "on" !== n2.meta.op && r2);
  for (a2 = V(e2); n2 = a2.pop(); )
    gt(n2, e2), r2 && "crosslink" === n2.family.type && yt(n2, t2, "on" !== n2.meta.op && r2);
};
var bt = (e2) => e2.clear();
var vt = (e2, { deep: t2 } = {}) => {
  let r2 = 0;
  if (e2.ownerSet && e2.ownerSet.delete(e2), Y(e2))
    bt(W(e2));
  else if (re(e2)) {
    r2 = 1;
    const t3 = e2.history;
...
var Ct = (t2, n2, a2, o2, i2, c2) => {
  ...
  const S2 = [_e((e2, t3, r2) => (r2.scope && !r2.scope.reg[g2.id] && (r2.c = 1), e2)), k2, qe({ store: y2, to: "b" }), _e((e2, { key: t3 }, r2) => {
    if (r2.c || e2 !== r2.a[t3])
      return n2 && r2.b && (r2.a = u2(r2.a)), r2.a[t3] = e2, 1;
  ...
  if (e(a2, (e2, t3) => {
    if (!Y(e2))
      return r(!Q(e2) && !xe(e2), `combine expects a store in a field ${t3}`, d2), void (m2[t3] = p2[t3] = e2);
  ...
  }), b2.defaultShape = a2, We(v2, { type: "map", from: g2, fn: i2 }), !be())
    if (i2) {
      const e2 = i2(m2);
...
//# sourceMappingURL=chunk-45TFZ7F4.js.map
