// node_modules/.pnpm/effector@22.8.8/node_modules/effector/effector.mjs
function e(e2, t2) {
  for (let r2 in e2)
    t2(e2[r2], r2);
}
...
function j(...t2) {
  ...
  if (m2 || g2)
    m2 && b2.add(s2), y2 = [m2 && Pe(W(s2), 0, 1), Fe({ safe: m2, filter: 1, pure: !m2, fn(e2, t3, r2) {
...
var pt = (e2, r2, a2, n2, i2) => {
  ...
  if (u2.id in e2.values.idMap)
    u2.current = e2.values.idMap[u2.id];
  else if (s2 && s2 in e2.values.sidMap && !(s2 in e2.sidIdMap))
    u2.current = d2(e2.values.sidMap[s2]);
...
//# sourceMappingURL=chunk-5QH7BTEJ.js.map
